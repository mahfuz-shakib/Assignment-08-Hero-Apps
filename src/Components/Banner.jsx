...
const Banner = () => {
  return (
    <div className="mt-12">
      <Container>
        <h1 className="text-3xl  sm:text-5xl font-bold text-center space-y-2">
          <p>We Build</p>
          <p>
            <span className="text-gradient">Productive</span> Apps
          </p>
        </h1>
        <p className=" text-[15px]  text-gray-500 mt-5 text-center px-5">
        ...
        <div className="w-fit mx-auto sm:space-x-4 space-y-3 sm:space-y-0 mt-8">
          ...
          <Link to="https://www.apple.com/app-store/" target="blank">
            <button className="btn mt-3 sm:mt-0 outline outline-sky-300 bg-white hover:scale-102  w-36">
        ...
        <div>
          <img className="mx-auto px-8 mt-8 h-40 sm:h-84" src={heroImg} alt="heroImg" />
        </div>
      </Container>
